...
CREATE INDEX idx_crossconfig_settings_category ON public.crossconfig_settings(category);
CREATE INDEX idx_crossconfig_settings_param ON public.crossconfig_settings(param);
CREATE INDEX idx_crossconfig_logs_user_id ON public.crossconfig_logs(user_id);
CREATE INDEX idx_crossconfig_logs_timestamp ON public.crossconfig_logs(timestamp DESC);
CREATE INDEX idx_crossconfig_versions_created_at ON public.crossconfig_versions(created_at DESC);
